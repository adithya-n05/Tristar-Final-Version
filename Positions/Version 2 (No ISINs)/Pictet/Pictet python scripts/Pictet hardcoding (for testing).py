...
wb_list = []
final_wb_directory = 'C:/Users/pierre.mancinelli/Desktop/Tristar Final/Positions/Version 2 (No ISINs)/Pictet/BBG Upload Template (Blank).xlsx'
final_wb_directory_save = 'c:/Users/pierre.mancinelli/Desktop/Tristar Final/Positions/Version 2 (No ISINs)/Pictet/BBG Upload Template (Ready).xlsx'
path = "c:/Users/pierre.mancinelli/Desktop/Tristar Final/Positions/Version 2 (No ISINs)/Pictet/Pictet position statements"
...
for i in range(len(New_Security_ID_list)):
    if str(New_Security_ID_list[i]) == "nan":
        ...
        New_price_list2.append(Cost_price[i])
